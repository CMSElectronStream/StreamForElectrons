...
void SimpleCutBasedElectronIDSelectionFunctor::initialize( Version_t version ){
    ...
    if (version_ == fiducial){
      ...
      set("maxNumberOfExpectedMissingHits", 1);
      set("conversionRejection",            1);      
      set("hoe_EB",      2.5e-01);     set("hoe_EE",      1.5e-01); 
      set("deta_EB",     7.0e-03);     set("deta_EE",     9.0e-03);
      set("dphi_EB",     8.0e-01);     set("dphi_EE",     7.0e-01);
      set("sihih_EB",    2.7e-02);     set("sihih_EE",    5.5e-02);      
      set("relTrackIso_EB", 2.5e-01);  set("relTrackIso_EE", 9.0e-02);
      set("relEcalIso_EB",  1.2e-00);  set("relEcalIso_EE",  9.0e-01);
      set("relHcalIso_EB",  6.0e-01);  set("relHcalIso_EE",  5.0e-01);      
      set("cIso_EB",       100000.);   set("cIso_EE",    100000.);
      ...
      set("relTrackIso_EB", 2.0e-02); set("relTrackIso_EE", 5.5e-02);
      set("relEcalIso_EB",  1.0e-00); set("relEcalIso_EE",  9.0e-01);
      set("relHcalIso_EB",  6.0e-01); set("relHcalIso_EE",  5.0e-01);      
      set("cIso_EB",       100000.);    set("cIso_EE",  100000.);
      set("ooemoop_EB",    0.050);    set("ooemoop_EE", 0.050);  
      ...
      set("cIso_EB",        6.0e-01); set("cIso_EE",    8.e-02);
      set("ooemoop_EB",    0.050);    set("ooemoop_EE", 0.050);  
    }
      ...
      set("relEcalIso_EB",  1000.);   set("relEcalIso_EE",  1000.);
      set("relHcalIso_EB",  1000.);   set("relHcalIso_EE",  1000.);      
      set("cIso_EB",        5.0e-01); set("cIso_EE",    7.5e-02);
      set("ooemoop_EB",    0.050);    set("ooemoop_EE", 0.050);  
    }
      ...
      set("relEcalIso_EB",  1000.);   set("relEcalIso_EE",  1000.);
      set("relHcalIso_EB",  1000.);   set("relHcalIso_EE",  1000.);      
      set("cIso_EB",        4.0e-02); set("cIso_EE",    6.5e-02);
      set("ooemoop_EB",    0.050);    set("ooemoop_EE", 0.050);  
    }
