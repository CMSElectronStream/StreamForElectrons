...
int main (int argc, char** argv){
  ...
  SetVariablesMapEntry(DistributionStreamMap,DistributionRecoMap,RatioMap);
  ...
  for( int iEvent = 0; iEvent < TreeIndexStream->GetN()/10 ; iEvent++ ) {
    ...
    if((*itVal)){
     ...
     RatioMap["ele1_fbrem"]->Fill(ele1_fbrem_s-ele1_fbrem_r);

     DistributionStreamMap["ele1_dxy_PV"]->Fill(ele1_dxy_PV_s);       
     DistributionRecoMap["ele1_dxy_PV"]->Fill(ele1_dxy_PV_r);
     RatioMap["ele1_dxy_PV"]->Fill(ele1_dxy_PV_s-ele1_dxy_PV_r);
     ...
     RatioMap["ele1_e5x5"]->Fill(ele1_e5x5_s-ele1_e5x5_r);

     DistributionStreamMap["ele1_e3x3"]->Fill(ele1_e3x3_s);       
     DistributionRecoMap["ele1_e3x3"]->Fill(ele1_e3x3_r);
     RatioMap["ele1_e3x3"]->Fill(ele1_e3x3_s-ele1_e3x3_r);
     ...
     RatioMap["ele1_es"]->Fill(ele1_es_s-ele1_es_r);
  ...
  std::map<std::string,TH1F*>::iterator itMap3 = RatioMap.begin();
 
  for( ; itMap3 != RatioMap.end() ; ++itMap3){
    ...
    canvasTemp->SaveAs(("plots/Difference_"+(itMap3)->first+".png").c_str(),"png"); 
  }
...
void SetVariablesMapEntry(std::map<std::string,TH1F*> & DistributionStreamMap, std::map<std::string,TH1F*> & DistributionRecoMap, std::map<std::string,TH1F*> & RatioMap){
  ...
  RatioMap.insert(mapElement("ele1_DphiIn",new TH1F("ele1_DphiInRatio","",50,-0.01,0.01)));       
  ...
  RatioMap.insert(mapElement("ele1_DetaIn",new TH1F("ele1_DetaInRatio","",50,-0.005,0.005)));       
  ...
  RatioMap.insert(mapElement("ele1_HOverE",new TH1F("ele1_HOverERatio","",50,-0.05,0.05)));       
  ...
  RatioMap.insert(mapElement("ele1_dxy_PV",new TH1F("ele1_dxy_PVRatio","",100,-0.5,0.5)));       
  ...
  RatioMap.insert(mapElement("ele1_dz_PV",new TH1F("ele1_dz_PVRatio","",50,-20,20)));       
  ...
  RatioMap.insert(mapElement("ele1_e5x5",new TH1F("ele1_e5x5Ratio","",100,-25,25)));       
  ...
  RatioMap.insert(mapElement("ele1_e3x3",new TH1F("ele1_e3x3Ratio","",100,-25,25)));       
  ...
  RatioMap.insert(mapElement("ele1_seedE",new TH1F("ele1_seedERatio","",100,-25,25)));       
